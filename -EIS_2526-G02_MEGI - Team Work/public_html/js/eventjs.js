...
function openForm(id = null) {
  ...
  if (id) {
    ...
    // fyll formuläret med datan från ev
    ...
    if (imageRow) imageRow.style.display = ''; // vi förfyller inte filfältet (det går inte i browsern)
...
form.addEventListener('submit', async (e) => {
  ...
  if (editingId !== null) {
    ...
    // vi editerar ett befintligt event
...
async function delEvent(id) {
  ...
  try {
    ...
    await loadEvents(); // ladda om listan
...
// >>> NY FUNKTION: LOAD COLLECTIONS FROM BACKEND (Lägg till HÄR)
...
async function loadCollections() {
    ...
    try {
        ...
        // Fyll i dropdown-menyn med data från API:et
